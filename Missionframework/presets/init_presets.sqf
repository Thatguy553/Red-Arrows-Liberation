...
switch (KP_liberation_preset_opfor) do {
    ...
    case 24: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\takistan_army.sqf";};
    case 25: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\rhs_afrf_winter.sqf";};
...
switch (KP_liberation_preset_resistance) do {
    ...
    case 10: {[] call compileFinal preprocessFileLineNumbers "presets\resistance\vn.sqf";};
...
switch (KP_liberation_preset_civilians) do {
    ...
    case  7: {[] call compileFinal preprocessFileLineNumbers "presets\civilians\vn.sqf";};
