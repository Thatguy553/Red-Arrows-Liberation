...
militia_squad = [
    "rhs_vdv_recon_sergeant",                                             // Rifleman
    "rhs_vdv_recon_grenadier_scout",                                             // Rifleman
    "rhs_vdv_recon_rifleman_ak103",                                             // Rifleman
    "rhs_vdv_recon_rifleman_lat",                                                  // Rifleman (AT)
    "rhs_vdv_recon_arifleman",                                            // Autorifleman
    "rhs_vdv_recon_marksman",                                             // Marksman
    "rhs_vdv_recon_medic",                                                // Medic
    "rhs_vdv_recon_grenadier"                                             // Engineer
];
