...
force ace_medical_spontaneousWakeUpEpinephrineBoost = 2.0;
...
force ace_medical_treatment_woundReopenChance = 0.10;
...
bocr_main_walk = false;

// Better CAS Environment
BCE_Access_list = 1;
BCE_Alpha_sdr = 1;
BCE_compass_fn = true;
BCE_FriendlyTrack_fn = true;
BCE_gun_IR_fn = true;
...
BloodLust_CleanUpDelay = 300;
BloodLust_CleanUpDistance = 500;
...
BloodLust_FallingVaporizationSpeedThreshold = 20;
...
BloodLust_IsCleanUpEnabled = false;
...
BloodLust_UnitVehicleVaporizationCollisionSpeed = 30;
BloodLust_UnitVehicleVaporizationProbability = 0.25;
BloodLust_VaporizationAmmoClassnames = "['MissileCore', 'RocketCore', 'TimeBombCore', 'GrenadeCore', 'ShellCore', 'BombCore']";
BloodLust_VaporizationDamageThreshold = 1;
...
acre_sys_core_premixGlobalVolume =2;
...
// Bundeswehr
BWA3_Leopard_ClocknumbersDir_Commander = true;
BWA3_NaviPad_showMembers = true;
BWA3_Puma_ClocknumbersDir_Commander = true;
BWA3_Puma_ClocknumbersDir_Gunner = true;
...
grad_trenches_functions_bigEnvelopeDigTime = 15;
...
grad_trenches_functions_smallEnvelopeDigTime = 15;
...
grad_trenches_functions_vehicleEnvelopeDigTime = 30;
...
force lambs_main_radioShout = 100.165;
...
vtx_uh60m_trackIR_interaction_cursor = true;
...
zen_faction_filter_1_TTT_Nimitz_Obj = true;
