...
// ACE Cook off
force ace_cookoff_ammoCookoffDuration = 0.001;
...
force ace_hearing_earplugsVolume = 0.333694;
force ace_hearing_enableCombatDeafness = true;
force ace_hearing_enabledForZeusUnits = false;
force ace_hearing_unconsciousnessVolume = 0.187139;
...
force ace_cargo_loadTimeCoefficient = 0.2;
...
force ace_repair_repairDamageThreshold = 0.600653;
force ace_repair_repairDamageThreshold_engineer = 0.904635;
...
force ace_medical_AIDamageThreshold = 0.07;
...
force ace_medical_statemachine_cardiacArrestTime = 270;
...
force ace_medical_treatment_treatmentTimeIV = 7.5;
...
// ACE Quick Mount
force ace_quickmount_distance = 7.90269;
...
force ace_hitreactions_minDamageToTrigger = 0.363636;
...
force acre_sys_core_postmixGlobalVolume = 2;
force acre_sys_core_premixGlobalVolume = 2;
force acre_sys_core_revealToAI = 1;
acre_sys_core_spectatorVolume = 1;
force acre_sys_core_terrainLoss = 0.5;
force acre_sys_core_ts3ChannelName = "ArmA 3 ACRE Comms";
...
force BCE_Access_list = 1;
BCE_Alpha_sdr = 1;
force BCE_compass_fn = true;
force BCE_FriendlyTrack_fn = true;
BCE_HUD_Color = [0.15,0.15,0.7];
BCE_HUD_fn = true;
force BCE_inf_IR_fn = true;
force BCE_inf_IR_Lig_fn = true;
force BCE_Mapicon_fn = true;
force BCE_touchMark_fn = true;
...
force BCE_TAC_Map_AIxcd_POS = true;
force BCE_veh_IR_S_fn = true;

// BettIR
BettIR_ViewDistance = 3600;
...
force CBRN_factionMask_rhs_faction_insurgents = "";
force CBRN_factionMask_rhs_faction_msv = "";
force CBRN_factionMask_rhs_faction_rva = "";
force CBRN_factionMask_rhs_faction_socom = "";
force CBRN_factionMask_rhs_faction_tv = "";
force CBRN_factionMask_rhs_faction_usaf = "";
force CBRN_factionMask_rhs_faction_usarmy = "";
force CBRN_factionMask_rhs_faction_usarmy_d = "";
force CBRN_factionMask_rhs_faction_usarmy_wd = "";
force CBRN_factionMask_rhs_faction_usmc = "";
force CBRN_factionMask_rhs_faction_usmc_d = "";
force CBRN_factionMask_rhs_faction_usmc_wd = "";
force CBRN_factionMask_rhs_faction_usn = "";
force CBRN_factionMask_rhs_faction_vdv = "";
force CBRN_factionMask_rhs_faction_vdv_45 = "";
force CBRN_factionMask_rhs_faction_vmf = "";
force CBRN_factionMask_rhs_faction_vpvo = "";
force CBRN_factionMask_rhs_faction_vv = "";
force CBRN_factionMask_rhs_faction_vvs = "";
force CBRN_factionMask_rhs_faction_vvs_c = "";
...
force grad_trenches_functions_bigEnvelopeDigTime = 10;
...
force grad_trenches_functions_giantEnvelopeDigTime = 15;
...
force grad_trenches_functions_smallEnvelopeDigTime = 8;
...
force grad_trenches_functions_vehicleEnvelopeDigTime = 20;
