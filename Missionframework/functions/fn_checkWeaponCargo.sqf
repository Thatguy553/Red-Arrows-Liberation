/*
    ...
    Description:
        Removes weapons not found in KP_liberation_allowed_items_extension from a cargo space.
...

{
    ...
    if ((toLower ([_x] call BIS_fnc_baseWeapon)) in KP_liberation_allowed_items_extension) then {
        ...
        if !(toLower _muzzle in _presetAttachments) then {
            if (toLower _muzzle in KP_liberation_allowed_items_extension) then {
        ...
        if !(toLower _pointer in _presetAttachments) then {
            if (toLower _pointer in KP_liberation_allowed_items_extension) then {
        ...
        if !(toLower _optic in _presetAttachments) then {
            if (toLower _optic in KP_liberation_allowed_items_extension) then {
        ...
        if !(toLower _bipod in _presetAttachments) then {
            if (toLower _bipod in KP_liberation_allowed_items_extension) then {
        ...
        if (_magazineClass isNotEqualTo "") then {
            if (toLower _magazineClass in KP_liberation_allowed_items_extension) then {
        ...
        if (_magazineGLClass isNotEqualTo "") then {
            if (toLower _magazineGLClass in KP_liberation_allowed_items_extension) then {
